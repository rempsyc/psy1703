...
Les deux moyennes seules ne disent pas :
- Combien de personnes ont participé : 4 ou 200?
- Si les changements se ressemblent : plusieurs personnes gagnent environ 12 points, ou quelques personnes font fortement monter la moyenne?
- Comment les groupes ont été constitués : répartition au hasard ou groupes déjà différents?
:::
...
[Passer à l’atelier après la pause](#atelier-appartenance)
...
**Quiz 1 (1,25 %) en début de séance**<br>
...
## Connectez-vous à Wooclap {#connexion-ronde-2} {visibility="hidden"}
...
## Wooclap — Ronde 2 · Rapport enregistré {visibility="hidden"}
...
## Wooclap — Ronde 2 · Transparence {visibility="hidden"}
...
## Wooclap — Ronde 2 · Partage {visibility="hidden"}
...
## Trois questions à poser devant une étude {#suite-ronde-2} {visibility="hidden"}
...
## Pour approfondir (pas à l'examen) {visibility="hidden"}

## Étudier des traces et des études existantes {visibility="hidden"}
...
## Préenregistrement et tailles d’effet : une comparaison historique {visibility="hidden"}
...
## Quelques solutions possibles {visibility="hidden"}
...
## Atelier 2 — Réparez cette étude (si nous avons le temps) {visibility="hidden"}
...
## Atelier 3 — Que peut-on honnêtement annoncer? (si nous avons le temps) {visibility="hidden"}
