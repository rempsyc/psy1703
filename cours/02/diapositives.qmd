...
## Connectez-vous à Wooclap {#connexion-quiz}
...
- **VI (variables indépendante) — l'intervention, ce que l'on manipule :** discussion ou réflexion individuelle.
- **VD (variables dépendante) — les résultats, ce que l'on mesure :** changement du score de certitude.
...
## Application — Appartenance et participation

En dyade : proposez une mesure du **sentiment d'appartenance** et une mesure de la **participation**.

Une personne dit se sentir intégrée, intervient peu et revient chaque semaine. Comment interpréter ces indices?

La **triangulation** confronte plusieurs mesures, y compris leurs désaccords.

::: {.notes}
Vallerand et Chénard-Poirier (2021), p. 45–51. Exemples originaux. Quelques minutes en dyades puis deux restitutions. Écouter peut être une manière de participer. Les indices ne mesurent pas nécessairement le même construit; leur convergence ne garantit pas la validité. Cette application prépare un rappel différé : Q1–Q6 sont regroupées à la fin de la Partie 1.
:::
...
## Atelier — Améliorer notre comparaison

Dans une étude proposée, une équipe discute; l'autre lit en silence. Les durées et les questions de mesure diffèrent aussi.

1. Quel effet cherche-t-on à isoler?
2. Quelles différences rendent la conclusion ambiguë?
3. Quelle modification prioriser?

::: {.notes}
Vallerand et Chénard-Poirier (2021), p. 33–38. Exemple fictif. Réponses : préciser l'hypothèse, rendre durée et mesure comparables, assigner les conditions au hasard. Relier à l'activité réelle de la robe : regroupement selon la perception, consignes multiples, absence de comparaison sans discussion. Le ressenti de changement ne démontre pas sa cause et ne prouve aucune différence de personnalité entre Bleus et Ors. Donner 3 minutes de réflexion puis 1 minute de retour.
:::
...
## Application — Que faudrait-il rendre explicite?

Notre équipe découvre une différence **seulement après avoir exclu plusieurs réponses**.

En dyade :

1. Quelles informations faut-il donner pour évaluer ce résultat?
2. Que partager pour permettre la vérification tout en protégeant les personnes?

::: {.notes}
Attendus : règle d'exclusion, chronologie, justification, résultats avec et sans exclusions lorsque pertinent, distinction prévu/exploratoire; protocole, questions et code; examiner séparément les données partageables et le consentement. Une exclusion peut être justifiée; son opportunisme et son omission sont les problèmes. Laisser deux minutes puis une restitution. Cet exercice ménage un délai avant la ronde 3.
:::
