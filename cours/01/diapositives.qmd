...
3. Gardez l'onglet ouvert : les questions apparaîtront au fil du cours.

Entre deux questions, l'écran d'attente est normal — vous pouvez ranger votre appareil.

Vos réponses serviront à réfléchir ensemble, pas à vous mettre sur la sellette.

::: {.notes}
Faire les questions essentielles de prise en main et de connaissance du groupe tirées du fichier questions-wooclap.md. Le code et le lien seront ajoutés lorsque l'événement sera créé. Utiliser un seul événement pour toute la séance; fermer chaque vote ou revenir aux diapositives pendant les blocs magistraux. Réafficher le code ou le QR au besoin pour les reconnexions. Une solution sans appareil demeure possible : réponse sur papier, discussion avec une personne voisine ou vote à main levée selon la question.
